...
timerlbl = tk.Label(rowFrame, text= 'Timer (s):', font = "TkDefaultFont 17") 
...
threshActlbl = tk.Label(rowFrame, text= 'Threshold Act:', font = "TkDefaultFont 17") 
...
threshQlbl = tk.Label(rowFrame, text= 'Threshold Q:', font = "TkDefaultFont 17") 
...
threshHstlbl = tk.Label(rowFrame, text= 'Threshold Hst:', font = "TkDefaultFont 17") 
