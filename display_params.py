...
from PyQt6.QtWidgets import QLabel, QLineEdit, QGridLayout, QGroupBox, QVBoxLayout, QHBoxLayout, QWidget, QScrollArea, QSizePolicy
...
def displayParams(tab1, storeHapParams, storeAvsParams, hap_description, avs_description, 
                  update_param_btn,log_data_btn, sync_time_btn):
    print()
    ...
    return updateHapParams, updateAvsParams, timerEntry